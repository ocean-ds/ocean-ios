...
//  (Storybook via WebView). Não é teste de regressão — é o gerador de imagens consumido
//  pelo CI. Renderiza o componente de verdade (UIHostingController), então divergências
//  reais de render aparecem nas imagens.
//
...
final class BannerSnapshotTests: XCTestCase {
    ...
    static func png<Content: View>(of view: Content, width: CGFloat) throws -> Data {
        ...
        // Anexa a uma janela para garantir o render completo da hierarquia.
