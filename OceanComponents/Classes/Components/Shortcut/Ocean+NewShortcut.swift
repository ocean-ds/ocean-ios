...
extension Ocean {
    public class NewShortcut: UIView {
        ...
        private lazy var contentStack: Ocean.StackView = {
            Ocean.StackView { stack in
                ...
                stack.spacing = NewShortcut.Constants.lineSpacing
            }
        }()
        ...
        public func set(data: [ShortcutModel], cols: Int = 2) {
            ...
            chunks.forEach { items in
                let stack = Ocean.StackView { stack in
                    ...
                    stack.alignment = .fill
                    stack.spacing = NewShortcut.Constants.interItemSpacing
                }

                items.forEach { model in
                    let view = Ocean.NewShorcutItem(orientation: orientation, size: size)
                    view.model = model
        ...
        public func getItemMinHeight() -> CGFloat {
            ...
            case .tiny:
                ...
                ? NewShortcut.Constants.minHeightTinyHorizontal
                : NewShortcut.Constants.minHeightTinyVertical
            case .small:
                return NewShortcut.Constants.minHeightSmall
            case .medium:
                return orientation == .horizontal
                ? NewShortcut.Constants.minHeightMediumHorizontal
                : NewShortcut.Constants.minHeightMediumVertical
            }
        }
