...
class BalanceSwiftUIViewController: UIViewController {
    ...
    private var model = OceanSwiftUI.BalanceModel(title: "Saldo total na Blu",
                                                  ...
                                                  actionCTA: "Receber",
                                                  acquirers: ["spaceX", "cielo", "getnet", "stone"],
    ...
    private var model5 = OceanSwiftUI.BalanceModel(title: "Saldo total na Blu",
                                                  ...
                                                  pendingValue: 1000000.0,
                                                  actionCTA: "Receber",
                                                   acquirers: ["teste", "safra", "mercadopago", "cielo", "getnet", "stone"],
                                                  displayMode: .amountMachines,
                                                  action: {
        print("Extrato")
    })
    ...
    private var model6 = OceanSwiftUI.BalanceModel(title: "Saldo total na Blu",
                                                  ...
                                                  pendingValue: 1000000.0,
                                                  actionCTA: "Receber",
                                                   acquirers: ["pagseguro", "safra", "mercadopago", "cielo", "getnet", "stone"],
                                                  displayMode: .amountMachines,
                                                  action: {
        print("Extrato")
    })
    ...
    private var model7 = OceanSwiftUI.BalanceModel(title: "Saldo total na Blu",
                                                  ...
                                                  pendingValue: 1000000.0,
                                                  actionCTA: "Receber",
                                                   acquirers: ["pagbank", "bancosafra", "mercadopago", "cielo", "getnet", "stone"],
                                                  displayMode: .amountMachines,
                                                  action: {
        print("Extrato")
    })
